  ...
  return (
    <div className="flex items-center justify-center">
      ...
      >
        ...
        <p className="font-bold text-[24px] mt-[38px]">Licence</p>
        <p className="font-normal mt-[25px] text-[15px] text-[#777777]">
          At vero eos et accusamus et iusto odio dignissimos ducimus qui
          blanditiis praesentium voluptatum deleniti atque corrupti quos dolores
          et quas molestias excepturi sint occaecati cupiditate non provident,
        ...
        <p className="font-bold text-[24px] mt-[38px]">Cookies</p>
        <p className="font-normal mt-[25px] text-[15px] text-[#777777]">
          At vero eos et accusamus et iusto odio dignissimos ducimus qui
          blanditiis praesentium voluptatum deleniti atque corrupti quos dolores
          et quas molestias excepturi sint occaecati cupiditate non provident,
        ...
        <p className="font-bold text-[24px] mt-[38px]">Content Liability</p>
        <p className="font-normal mt-[25px] text-[15px] text-[#777777]">
          At vero eos et accusamus et iusto odio dignissimos ducimus qui
          blanditiis praesentium voluptatum deleniti atque corrupti quos dolores
          et quas molestias excepturi sint occaecati cupiditate non provident,
