    ...
    <div className="mx-[150px] my-[50px] ">
      <div className="flex gap-4">
        <div
          ...
          className="w-[25%] rounded-2xl   border-[1px] border-[#0000001F]"
        >
        ...
        <div className="w-[75%] ">
          <div className="w-[100%] flex justify-between gap-8  h-[384px] pl-[100px] bg-[#FF9C2A] rounded-sm">
            <div className="w-[50%] pt-[60px]">
              <p className="text-white text-[24px] font-semibold">
                Special Offer
              </p>
              <p className="text-white text-[64px] font-bold">Super Sale</p>
              <p className="text-white text-[24px]  font-semibold">
                Up To 50% Off
              </p>
            ...
            <div>
              <Image alt="" src={Baner} className="w-[560px] h-[385px] " />
            </div>
          </div>
          <div className="flex justify-between items-start gap-2 mt-5 ">
            ...
            <div
              ...
              className="group h-[398px] mt-[24px] border-[1px] border-[#5C545433] rounded-2xl hover:border-[1px] border-[#F70001] "
            >
              ...
              <div className="flex items-center p-4  gap-2">
                <div className="w-[25%]">
                  ...
                  />
                  <p className="text-[12px] text-center font-normal">John</p>
                </div>
                <div className="w-[25%]">
                  <Image
                    alt=""
                    ...
                    className="w-[44px] h-[44px]  rounded-xl"
                  />
                  <p className="text-[12px] text-center font-normal">James</p>
                </div>
                <div className="w-[25%]">
                  <Image
                    alt=""
                    ...
                    className="w-[44px] h-[44px]  rounded-xl"
                  />
                  <p className="text-[12px] text-center font-normal">Robert</p>
                </div>
                <div className="w-[25%]">
                  <Image
                    alt=""
          ...
          <div className="flex justify-between items-start gap-2 mt-5 ">
            ...
            <div
              ...
              className="group h-[398px] p-5 bg-[#FF8A1D14] mt-[24px] rounded-2xl hover:border-[1px] border-[#F70001] "
            >
